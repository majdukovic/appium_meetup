...
class TestLogin():
    ...
    def test_01_login(self):
        ...
        #time.sleep(1)
        self.driver.find_element_by_id('com.matchbook.client:id/editTextPassword').send_keys('pass')
        ...
        self.driver.find_element_by_id('com.matchbook.client:id/pinPwd').send_keys('pass')
        #time.sleep(2)
